		...
		<view class="wallet_bg">
			<view class="top_box jui_bg_fff jui_mar_2432 jui_flex_col_center">
				...
				<view class="" >
					...
					<text
						class="jui_fs34 jui_fc_333">5658</text>
				</view>
				<view class="jui_h60">
				...
				<view class="jui_flex jui_flex_items_center jui_flex_justify_between" style="width: 85%;">
					...
					<view class="jui_flex box" >
						<!-- <view class="jui_flex box" @tap="goPage(`/pages/wallet/withdrawal`)"> -->
						<view class="">
							提现
						</view>
						<image src="/static/imgs/home/tb.png" style="height: 40rpx;width: 54rpx;" mode=""></image>
					</view>
					<!-- <view class="jui_flex box" @tap="goPage('/pages/wallet/huzhuan')">
						<view class="">
							互转
						</view>
						<image src="/static/imgs/home/tb.png" style="height: 40rpx;width: 54rpx;" mode=""></image>
		...
		<view class="jui_mar_2432">
			<view class="jui_bg_f5f jui_pad_2432 jui_bor_rad_15" @tap="jump('/pages/wallet/balance')">
				...
				<view class="jui_flex jui_flex_justify_between jui_flex_items_center">
					<view class="">
						<text class="jui_fc_333">灵活资产</text>
						<!-- <text>(U)</text> -->
					</view>
				</view>
				<view class="jui_h30">
			...
			<view class="jui_bg_f5f jui_pad_2432 jui_bor_rad_15">
				...
				<view class="jui_flex  jui_flex_items_center">
					<view class="" style="width: 50%;">
						<text class="jui_fc_333">已投资产</text>
					</view>
				</view>
				<view class="jui_h30">
			...
			<view class="jui_bg_f5f jui_pad_2432 jui_bor_rad_15">
				...
				<view class="jui_flex  jui_flex_items_center">
					<view class="" style="width: 80%;">
						<text class="jui_fc_333">平台虚拟信用分 (总分100)</text>
					</view>
				</view>
				<view class="jui_h30"></view>
				<view class="x-bc l-h2" >
					<view class="flex1">
						<view class="">平台信用分</view>
						<view class="">85</view>
					</view>
					<view class="flex1 tc">
